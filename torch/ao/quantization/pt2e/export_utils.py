    ...
    for inplace in [False, True]:
        ...
        if train_to_eval:
            match_pattern = _get_aten_graph_module_for_pattern(
                _WrapperModule(dropout_train), example_inputs, using_training_ir=using_training_ir
            )
            replacement_pattern = _get_aten_graph_module_for_pattern(
                _WrapperModule(dropout_eval), example_inputs, using_training_ir=using_training_ir
            )
        else:
            match_pattern = _get_aten_graph_module_for_pattern(
                _WrapperModule(dropout_eval), example_inputs, using_training_ir=using_training_ir
